...
export class NotesComponent implements OnInit {
  ...
  data = [{
    ...
    "name": "Minette Shirtliff",
    "username": "mshirtliff5",
    "para": "In congue. Etiam justo. Etiam pretium iaculis justo.",
    "color": "red",
  }, {
    "name": "Augusta Vasyanin",
    "username": "avasyanin6",
    ...
    "name": "Arch Danbrook",
    "username": "adanbrook8",
    "para": "Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.",
    "color": "yellow",
  }, {
    "name": "Edyth Marnane",
    "username": "emarnane9",
